Readme still under construction, if you want to see the current state of the project, please check the `main_design_notebook.ipynb` which can be opened here: 
